...
<Project Type="Project" LVVersion="8608002">
	...
	<Item Name="RT CompactRIO Target" Type="RT CompactRIO">
		...
		<Property Name="alias.value" Type="Str">10.0.79.02</Property>
...
KeepAliveTimeout 60
		...
		<Item Name="Dashboard code" Type="Folder">
			...
			<Item Name="K14DriverButtonName.ctl" Type="VI" URL="../K14DriverButtonName.ctl"/>
			<Item Name="DriverStationButtonMapping.vi" Type="VI" URL="../DriverStationButtonMapping.vi"/>
		</Item>
		<Item Name="Team Code" Type="Folder">
			...
			<Item Name="DeployMiniBotToThePole.vi" Type="VI" URL="../DeployMiniBotToThePole.vi"/>
			<Item Name="Get Robot Competition Mode.vi" Type="VI" URL="../Get Robot Competition Mode.vi"/>
			<Item Name="StopAllMotors.vi" Type="VI" URL="../StopAllMotors.vi"/>
		</Item>
		<Item Name="Vision Code" Type="Folder">
			<Item Name="Vision Processing.vi" Type="VI" URL="../Vision Processing.vi"/>
			<Item Name="Update Camera Status.vi" Type="VI" URL="../Update Camera Status.vi"/>
		</Item>
		<Item Name="SensorControlModule" Type="Folder">
			<Item Name="Inertial" Type="Folder">
				<Item Name="Get Robot Attitude Data.vi" Type="VI" URL="../Get Robot Attitude Data.vi"/>
				<Item Name="Get Robot Velocity Data.vi" Type="VI" URL="../Get Robot Velocity Data.vi"/>
				<Item Name="Robot Attitude Data type.ctl" Type="VI" URL="../Robot Attitude Data type.ctl"/>
				<Item Name="Robot Velocity Data type.ctl" Type="VI" URL="../Robot Velocity Data type.ctl"/>
			</Item>
			<Item Name="LineFollowerSensorStates.ctl" Type="VI" URL="../LineFollowerSensorStates.ctl"/>
			<Item Name="LineFollowerModule.vi" Type="VI" URL="../LineFollowerModule.vi"/>
			<Item Name="OpticalEncoderCalibration.vi" Type="VI" URL="../OpticalEncoderCalibration.vi"/>
			<Item Name="Serial protocol.vi" Type="VI" URL="../Serial protocol.vi"/>
			<Item Name="ReadAndLogForEncoderAndSonar.vi" Type="VI" URL="../ReadAndLogForEncoderAndSonar.vi"/>
			<Item Name="LineFollower2_SensorModule.vi" Type="VI" URL="../LineFollower2_SensorModule.vi"/>
		</Item>
		<Item Name="CalibrationCode" Type="Folder">
			<Item Name="CalibrationParamK14ValidNames.ctl" Type="VI" URL="../CalibrationParamK14ValidNames.ctl"/>
			<Item Name="ParameterRegistryCalibrationData.vi" Type="VI" URL="../ParameterRegistryCalibrationData.vi"/>
			<Item Name="FileReadK14CalibrationParam.vi" Type="VI" URL="../FileReadK14CalibrationParam.vi"/>
			<Item Name="FileWriteK14CalibrationParam.vi" Type="VI" URL="../FileWriteK14CalibrationParam.vi"/>
			<Item Name="K14_CalibrationControlParameterSetting.vi" Type="VI" URL="../K14_CalibrationControlParameterSetting.vi"/>
		</Item>
		<Item Name="Rolling Control" Type="Folder">
			<Item Name="GyroCorrectedK14_SteeringAdjustment.vi" Type="VI" URL="../GyroCorrectedK14_SteeringAdjustment.vi"/>
			<Item Name="Modulus180_RangeChecking.vi" Type="VI" URL="../Modulus180_RangeChecking.vi"/>
			<Item Name="SteeringCommandsCluster.ctl" Type="VI" URL="../SteeringCommandsCluster.ctl"/>
			<Item Name="JoystickCrabDriveAngleN_Power.vi" Type="VI" URL="../JoystickCrabDriveAngleN_Power.vi"/>
			<Item Name="AcellerateMotorsAtFixedRate.vi" Type="VI" URL="../AcellerateMotorsAtFixedRate.vi"/>
			<Item Name="CarSteerMode.vi" Type="VI" URL="../CarSteerMode.vi"/>
			<Item Name="HurricanDriveMode.vi" Type="VI" URL="../HurricanDriveMode.vi"/>
			<Item Name="SteeringMotorK14_PowerControl.vi" Type="VI" URL="../SteeringMotorK14_PowerControl.vi"/>
			<Item Name="WheelRollingK14_SpeedController.vi" Type="VI" URL="../WheelRollingK14_SpeedController.vi"/>
			<Item Name="SteeringRollingK14_ControlLoop.vi" Type="VI" URL="../SteeringRollingK14_ControlLoop.vi"/>
			<Item Name="PowerCasterSteerJoystickControl.vi" Type="VI" URL="../PowerCasterSteerJoystickControl.vi"/>
			<Item Name="HumanDriverRollN_SteeringControl.vi" Type="VI" URL="../HumanDriverRollN_SteeringControl.vi"/>
			<Item Name="SteeringOpticalEncoderReader.vi" Type="VI" URL="../SteeringOpticalEncoderReader.vi"/>
			<Item Name="PowerCasterEncoderModule.vi" Type="VI" URL="../PowerCasterEncoderModule.vi"/>
		</Item>
		<Item Name="Manipulator and ladder code" Type="Folder">
			<Item Name="LadderControlCommands.ctl" Type="VI" URL="../LadderControlCommands.ctl"/>
			<Item Name="LadderControlModule.vi" Type="VI" URL="../LadderControlModule.vi"/>
			<Item Name="ArmControl.vi" Type="VI" URL="../ArmControl.vi"/>
			<Item Name="FingersControl.vi" Type="VI" URL="../FingersControl.vi"/>
			<Item Name="ManipulatorInterface.vi" Type="VI" URL="../ManipulatorInterface.vi"/>
		</Item>
		<Item Name="Autonomous code" Type="Folder">
			<Item Name="FollowRightLine.vi" Type="VI" URL="../FollowRightLine.vi"/>
			<Item Name="CompleteSetAutonomousSteps.ctl" Type="VI" URL="../CompleteSetAutonomousSteps.ctl"/>
			<Item Name="AutonomousSelectionOption.ctl" Type="VI" URL="../AutonomousSelectionOption.ctl"/>
			<Item Name="FollowLeftLine.vi" Type="VI" URL="../FollowLeftLine.vi"/>
			<Item Name="VerifyNoLineSkullLeft.vi" Type="VI" URL="../VerifyNoLineSkullLeft.vi"/>
			<Item Name="OneModeToRuleThemAll.ctl" Type="VI" URL="../../../Working area/Victoria Evenstar/OneModeToRuleThemAll.ctl"/>
			<Item Name="LastAutoModeToRuleThemAll.vi" Type="VI" URL="../../../Working area/Victoria Evenstar/LastAutoModeToRuleThemAll.vi"/>
			<Item Name="AutonomousIterative.vi" Type="VI" URL="../AutonomousIterative.vi"/>
			<Item Name="AutonomousSelectionReadN_Store.vi" Type="VI" URL="../AutonomousSelectionReadN_Store.vi"/>
			<Item Name="FollowStraitLineTopPeg.vi" Type="VI" URL="../FollowStraitLineTopPeg.vi"/>
			<Item Name="VerifyNoLineSkullRight.vi" Type="VI" URL="../VerifyNoLineSkullRight.vi"/>
			<Item Name="MoveRobotUsingLineFollower.vi" Type="VI" URL="../MoveRobotUsingLineFollower.vi"/>
			<Item Name="DoubleUberTubeAutonomousMethod.vi" Type="VI" URL="../DoubleUberTubeAutonomousMethod.vi"/>
		</Item>
		<Item Name="DataLogging code" Type="Folder">
			<Item Name="LogFilenameRegistry.vi" Type="VI" URL="../LogFilenameRegistry.vi"/>
			<Item Name="LogK14DataOptions.ctl" Type="VI" URL="../LogK14DataOptions.ctl"/>
			<Item Name="WriteLogDataToFile.vi" Type="VI" URL="../WriteLogDataToFile.vi"/>
			<Item Name="LogItemSelectionRegistry.vi" Type="VI" URL="../LogItemSelectionRegistry.vi"/>
			<Item Name="Timeout.vi" Type="VI" URL="../Timeout.vi"/>
			<Item Name="LoggingDataValuesRegistry.vi" Type="VI" URL="../LoggingDataValuesRegistry.vi"/>
			<Item Name="OpenLogFile.vi" Type="VI" URL="../OpenLogFile.vi"/>
		</Item>
		<Item Name="Robot Main.vi" Type="VI" URL="../Robot Main.vi"/>
		<Item Name="CK14_parameters.cfg" Type="Document" URL="../CK14_parameters.cfg"/>
		<Item Name="whattolog.cfg" Type="Document" URL="../whattolog.cfg"/>
		<Item Name="Dependencies" Type="Dependencies">
			<Item Name="vi.lib" Type="Folder">
				...
				<Item Name="NI_Real-Time Target Support.lvlib" Type="Library" URL="/F/Language/National Instruments/LabVIEW 8.6/Targets/NI/RT/vi.lib/NI_Real-Time Target Support.lvlib"/>
				...
				<Item Name="ni_emb.dll" Type="Document" URL="/F/Language/National Instruments/LabVIEW 8.6/Targets/NI/RT/vi.lib/ni_emb.dll"/>
			</Item>
			...
			<Item Name="visarc" Type="Document" URL="/F/Language/National Instruments/LabVIEW 8.6/resource/visarc"/>
		...
		<Item Name="Build Specifications" Type="Build">
			<Item Name="FRC Robot Boot-up Deployment" Type="{69A947D5-514E-4E75-818E-69657C0547D8}">
				...
				<Property Name="RTExe_localDestPath" Type="Path">/C/FRC build files - DO NOT DELETE/Krunch-14 robot build</Property>
				<Property Name="RTExe_localDestPathType" Type="Str">&lt;none&gt;</Property>
				<Property Name="Source[0].itemID" Type="Str">{FF778CAA-D142-4B9A-9AF9-71A99B02CC48}</Property>
